...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post gifts_url, params: { gift: { country: @gift.country, link: @gift.link, store: @gift.store } }
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { country: @gift.country, link: @gift.link, store: @gift.store } }
